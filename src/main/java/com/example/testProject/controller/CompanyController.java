...
public class CompanyController {
    ...
    @GetMapping("page")
    @ApiOperation(value = "Page Companies", tags = "pageCompanies")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Success")})
    public ResponseEntity<Page<Company>> pageCompanies(@PageableDefault(sort = {"id"}, direction = Sort.Direction.DESC) Pageable pageable) {
        Page<Company> page;
